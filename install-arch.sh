...
sudo pacman -S xorg exa alacritty bspwm sxhkd polybar rofi firefox vim ttf-iosevka-nerd feh pulsemixer brightnessctl bc feh imagemagick xorg-xdpyinfo xorg-xrandr --needed
